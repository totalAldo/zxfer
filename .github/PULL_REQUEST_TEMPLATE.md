...
- [ ] `./tests/run_perf_tests.sh` or `./tests/run_vm_matrix.sh --test-layer perf` when performance-sensitive behavior changed
...
- manual performance baselines or VM-backed perf artifacts; perf is informative
